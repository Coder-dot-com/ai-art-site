...
urlpatterns = [
    ...
    path('submit_shipping_form/<order_number>', views_htmx.submit_shipping_form, name="submit_shipping_form"),
    ...
    path('shipping_options/<order_number>/', views_htmx.shipping_options, name="shipping_options"),
